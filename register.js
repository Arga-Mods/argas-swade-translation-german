...
// Ohne das Originalmodul findet keine Übersetzung statt. Die `requires`-Angabe
// in module.json lässt sich entfernen, daher zusätzlich diese Laufzeit-Prüfung.
...
function argaRegisterSettings() {
  ...
  game.settings.register(MODULE_ID, 'welcomeDismissed', {
    ...
    hint: 'Das Begrüßungsfenster wird ausgeblendet, solange alle Voraussetzungen erfüllt sind. Fehlt später wieder eine davon – etwa die metrische Gewichtseinheit –, erscheint es erneut.',
    scope: 'client',
    config: true,
    type: Boolean,
    default: false,
...
// Englische Aktionsnamen -> Deutsch. Genutzt vom actionButtons-Converter und vom
// Anzeige-Patch fuer die vom System eingefuegten Aktions-Knoepfe weiter unten -
// eine Tabelle, damit beide Wege identisch uebersetzen.
const ACTION_NAME_MAP = {
  ...
  "Heal Selected": "Ausgewählte heilen",
  "Resist": "Widerstehen",
  ...
  "Shake Off (Strong)": "Effekt abschütteln (Stark)",
  "Spirit": "Willenskraft",
  "Spirit (Raise)": "Willenskraft (Steigerung)",
  "Vigor": "Konstitution",
  "Vigor (Raise)": "Konstitution (Steigerung)",
  ...
  "Short Range": "Kurze Entfernung",
  "Medium Range": "Mittlere Entfernung",
  "Long Range": "Weite Entfernung",
  "Close Range": "Kurze Entfernung",
  ...
  "Resist Poison": "Widerstehen (Gift)",
  "Resist Poison (-4)": "Widerstehen (Gift, -4)",
  "Wild Attack": "Rücksichtsloser Angriff",
  "Apply Cards": "Karte(n) anbieten",
  "Attempt to Acquire Skill": "Fertigkeit erwerben",
  "Support (Performance)": "Unterstützen (Darbietung)",
  "Support (Persuasion)": "Unterstützen (Überreden)",
  "Test (Intimidation)": "Herausfordern (Einschüchtern)",
  "Test (Taunt)": "Herausfordern (Provozieren)",
  ...
  // Wortlaut muss mit argas-swade-scifi-companion-german uebereinstimmen: beide
  // Module schreiben system.actions.additional, bei abweichenden Werten
  // entschiede die Auswertungsreihenfolge.
  "Bash": "Zuschlagen",
};

// Englische Ausprägungstexte der Mächte (system.trapping) -> Deutsch. Nötig für
// in Akteure eingebettete Mächte: die haben keine Eintragsdaten und blieben
// sonst englisch. Werte wörtlich aus den Pack-Einträgen.
const POWER_TRAPPING_MAP = {
  "Concentration, a dull glow around the protected character, a fetish": "Konzentration, ein schwaches Leuchten um den beschützten Charakter, ein Fetisch.",   // Arcane Protection
  "Holy items, arcane symbols, handful of salt": "Heilige Gegenstände, arkane Symbole, eine Handvoll Salz.",   // Banish
  "Fire, ice, thorns, force, bones, energy.": "Feuer, Eis, Dornen, Kraftfeld, Knochen, Energie.",   // Barrier
  "The caster concentrates and gestures with his hands.": "Der Wirker konzentriert sich und gestikuliert mit den Händen.",   // Beast Friend
  "Balls of fire, ice, light, darkness, colored bolts, swarm of insects": "Bälle aus Feuer, Eis, Licht, Dunkelheit, farbige Geschosse, Insektenschwärme.",   // Blast
  "Bright flash of light, sand in eyes, confusion": "Heller Lichtblitz, Sand in den Augen, Verwirrung.",   // Blind
  "Fire, ice, light, darkness, colored bolts, a stream of insects": "Feuer, Eis, Licht, Dunkelheit, farbige Geschosse, Insektenschwärme.",   // Bolt
  "Physical change, glowing aura, potions": "Körperliche Veränderung, leuchtende Aura, Tränke.",   // Boost/Lower Trait
  "Dissolving into the earth and appearing elsewhere.": "Mit der Erde verschmelzen und anderswo wieder auftauchen.",   // Burrow
  "A shower of flames, light or other matter of energy.": "Ein Schwall aus Flammen, Licht oder anderer Materie oder Energie.",   // Burst
  "Hypnotic lights, brief illusions, loud noises.": "Hypnotisches Licht, kurze Illusionen, laute Geräusche.",   // Confusion
  "Fiery aura, spikes, electrical field": "Flammenaura, Stacheln, elektrisches Feld",   // Damage Field
  "Glowing eyes, dilated pupils, sonic sight": "Leuchtende Augen, erweiterte Pupillen, Ultraschall-Sicht.",   // Darksight
  "Mystical shield, gust of wind, phantom servant that intercepts missiles": "Mystischer Schild, Windstoß, Geist der Geschosse abfängt.",   // Deflection
  "Waving hands, whispered words.": "Handgewedel, geflüsterte Worte.",   // Detect/Conceal Arcana
  "Malleable features, illusionary appearance, hair of new form": "Verformbare Züge, illusionäres Aussehen, Haare der neuen Gestalt.",   // Disguise
  "Waving hands, whispered words": "Handgewedel, geflüsterte Worte.",   // Dispel
  "Seances, prayers, demonic interrogation.": "Seancen, Gebete, dämonisches Verhör.",   // Divination
  "Prayer, whispered words, gestures": "Gebete, geflüsterte Worte, Gesten.",   // Drain Power Points
  "A few simple gestures": "Einige einfache Gesten.",   // Elemental Manipulation
  "Concentration, a warm or sympathetic smile, exchanging a pleasantry": "Konzentration, ein warmes oder mitfühlendes Lächeln, Nettigkeiten austauschen.",   // Empathy
  "Glue bomb, vines, handcuffs, webs.": "Leimbombe, Ranken, Handschellen, Netze.",   // Entangle
  "A mark on the forehead, potions, gills.": "Ein Zeichen auf der Stirn, Tränke, Kiemen.",   // Environmental Protection
  "Invisibly marked targets, guiding winds, eagle eyes": "Mega-Zoom-Brille, Projektion des eigenen Bewusstseins, Adleraugen.",   // Farsight
  "Gestures, eldritch energy, cold chills": "Gesten, unheimliche Energie, kaltes Schaudern.",   // Fear
  "Gusty winds, wings, broomsticks": "Windstöße, Schwingen, Hexenbesen.",   // Fly
  "Gestures, words of power, potions": "Gesten, Worte der Macht, Tränke.",   // Growth/Shrink
  "Whirlwind, chaotic poltergeists, repulsion field": "Ausprägungen: Wirbelwind, chaotische Poltergeister, Abstoßungsfeld.",   // Havoc
  "Laying on hands, touching the victim with a holy symbol, prayer": "Hände auflegen, das Opfer mit einem heiligen Symbol berühren, Gebete.",   // Healing
  "Magical spells, holograms, \"ethereal materializers\"": "Magische Zauberformeln, Hologramme, \"Äthermaterialisatoren\"",   // Illusion
  "Ghost form, body of shadow, gaseous transformation": "Geistergestalt, Schattenkörper, Verwandlung in Gas.",   // Intangibility
  "Powder, potion, iridescent lights": "Pulver, Trank, schillernde Lichter.",   // Invisibility
  "Illusionary torch, sunlight, darkness, thick fogs": "Illusionäre Fackel, Sonnenlicht, Dunkelheit, dichter Nebel.",   // Light / Darkness
  "Headpieces, talismans, of Tao or other gods, crystals": "Kopfschmuck, Talismane von Tao oder anderen Göttern, Kristalle.",   // Mind Link
  "Psionic invasion, soulsight": "Psionisches Eindringen, Seelensicht.",   // Mind Reading
  "A noxious drink, parasites, touching the target's temples": "Ein abscheuliches Getränk, Parasiten, Berührung der Schläfen des Ziels.",   // Mind Wipe
  "Touching the object, glowing hands": "Gegenstand berühren, leuchtende Hände",   // Object Reading
  "A mystical glow, hardened skin, ethereal armor, a mass of nanites": "Ein mystisches Leuchten, gehärtete Haut, ätherische Rüstung, eine Masse aus Naniten.",   // Protection
  "Glowing eyes, trance-like state, a swinging pocket watch, voodoo dolls.": "Leuchtende Augen, tranceartiger Zustand, eine baumelnde Taschenuhr, Voodoo-Puppen.",   // Puppet
  "Prayer, tonics": "Gebete, Tonikum",   // Relief
  "Elaborate ceremonies, rare plants, magical amulets, divine intervention": "Komplexe Zeremonien, seltene Pflanzen, magische Amulette, göttliche Intervention.",   // Resurrection
  "\"Morphing\", talismans, tattoos": "\"Morphen\", Talismane, Tätowierungen.",   // Shape Change
  "Slowing time, blurred motion, a slippery patch of oil or ice": "Verlangsamte Zeit, verschwommene Bewegungen, ein rutschiger Fleck Öl oder Eis.",   // Sloth/Speed
  "A lullaby, blowing powder or sand at targets": "Ein Wiegenlied, Pulver oder Sand auf die Ziele pusten.",   // Slumber
  "A colored glow, runes, sigils, crackling energy, barbs grow from the blade": "Ein farbiges Leuchten, Runen, knisternde Energie, Stacheln (die aus der Klinge wachsen).",   // Smite
  "Magical effects, a brief ripple in the air, a bell or chime that starts or stops ringing": "Magische Effekte, ein kurzes Kräuseln in der Luft, eine Glocke oder ein Klingen, das beginnt oder aufhört.",   // Sound/Silence
  "Words, pictures, hand motions": "Worte, Bilder, Handbewegungen.",   // Speak Language
  "Bolts of energy, stun bombs, sonic booms, burst of blinding light": "Energiegeschosse, Betäubungs­bomben, Überschallknall, blendendes Licht.",   // Stun
  "Clay figure that grows into a servant, a tattoo that comes to life.": "Lehmfigur, die zu einem Diener heranwächst, eine Tätowierung, die zum Leben erwacht.",   // Summon Ally
  "A wave of the hand, magic wand, steely gaze": "Ein Wedeln mit der Hand, Zauberstab, stählerner Blick.",   // Telekinesis
  "A cloud of smoke, \"phasing\" out, change into a bolt of lightning": "Eine Wolke aus Rauch; „Ausblenden“; Verwandlung in einen Blitz.",   // Teleport
  "Spider-like visage, prickly hairs on hands and feet": "Spinnenartiges Aussehen, stachelige Haare an Händen und Füßen.",   // Wall Walker
  "Gestures, prayer, whispered words, concentration": "Gesten, Gebete, geflüsterte Worte, Konzentration.",   // Warrior's Gift
  "Carving symbols on corpses, throwing bones, graveyards, \"leather\" books": "Symbole in eine Leiche schneiden, Knochen werfen, Friedhöfe, Bücher mit „Ledereinband“.",   // Zombie
};

const converters = {
  // Ausprägung einer Macht (system.trapping). Eintrags-Übersetzung hat Vorrang,
  // sonst Nachschlagen für eingebettete Mächte ohne Eintragsdaten. Unbekanntes
  // liefert undefined, damit Babele das Feld nicht schreibt: Item.power gilt
  // modulübergreifend, ein zurückgegebener Originaltext überschriebe die
  // Ausprägung fremder SWADE-Module.
  "powerTrapping": (original, translation) => {
    if (typeof translation === 'string' && translation) return translation;
    if (typeof original !== 'string') return undefined;
    return POWER_TRAPPING_MAP[original];
  },
  ...
  "edgeCategory": (category) => {
    const map = {
      ...
      "Weird": "Übersinnlich",
      "Legendary": "Legendär",
      "Edge Actions": "Talent-Aktionen",
      // Reparatur-Eintrag: Die Woerterbuecher schluesseln nach dem ENGLISCHEN
      // Wert, deshalb erreicht die Zeile darueber Welten nicht, in denen der
      // alte deutsche Wert schon steht. Nicht entfernen.
      "Vorteilsaktionen": "Talent-Aktionen",
      "": ""
    };
  ...
  // Nur exakt "Charges" wird ersetzt, damit selbst vergebene Ladungsnamen
  // unangetastet bleiben; alle übrigen Felder bleiben erhalten.
  "chargeNames": (charges) => {
  ...
  "rankRequirement": (requirements) => {
    ...
    const SKILL_LABEL = {
      ...
      "Riding": "Reiten",
      "Science": "Naturwissenschaften",
      // Reparatur-Eintrag für Welten, in denen "Wissenschaft W8+" steht.
  ...
  // Reichweite bei Mächten (system.range): "Sm"/"Smarts" → "Verstand",
  // "x 2" → "x2" vereinheitlichen.
  "powerRange": (range) => {
  ...
  // system.actions.trait: der deutsche Wert muss zum Fertigkeits-/Attributnamen
  // auf dem Charakterbogen passen, sonst findet SWADE die Probe nicht.
  // Unbekanntes liefert `undefined` statt des Originals (siehe "actionButtons").
  // Trägt die Eintrags-Übersetzung ein „Aktionen"-Objekt, stellt sich dieses
  // Wörterbuch zurück: sonst belegen Typ- und Pack-Zuordnung denselben Pfad mit
  // verschiedenen Werten und der Welt-Konverter schreibt sie abwechselnd.
  "actionTrait": (trait, translation, _quelle, _kompendium, alle) => {
    if (typeof translation === 'string' && translation) return translation;
    if (alle?.Aktionen && typeof alle.Aktionen === 'object') return undefined;
    if (typeof trait !== 'string' || !trait) return undefined;
    const map = {
      "Persuasion": "Überreden",
      "Intimidation": "Einschüchtern",
      "Fighting": "Kämpfen",
      ...
      "Riding": "Reiten",
      "Science": "Naturwissenschaften",
      // Reparatur-Eintrag für Welten mit dem alten Wert.
      "Wissenschaft": "Naturwissenschaften",
      "Spellcasting": "Zaubern",
      "Survival": "Überleben",
      "Taunt": "Provozieren",
  ...
  // GILT AUCH FÜR "actionTrait" UND "weaponNotes":
  // Auf system.notes, system.actions.additional und system.actions.trait
  // schreibt auch argas-swade-scifi-companion-german, dort unter anderen
  // Feldnamen. Babele hält die Zuordnungen deshalb für eigenständig und wendet
  // beide nacheinander auf denselben Pfad an – wer zuletzt schreibt, gewinnt.
  // Ein Converter darf hier also NUR zurückgeben, was er wirklich übersetzt hat:
  // bei Objekten ein Teilobjekt (Babele mischt es per mergeObject ein), sonst
  // `undefined`. Gibt er den Originalwert zurück, überschreibt er damit die
  // fertige Übersetzung des anderen Moduls.
  "actionButtons": (additional, translation, _quelle, _kompendium, alle) => {
    ...
    // Eintrag mit „Aktionen"-Objekt hat Vorrang – siehe "actionTrait".
    if (alle?.Aktionen && typeof alle.Aktionen === 'object') return undefined;
    if (!additional || typeof additional !== 'object' || Array.isArray(additional)) return undefined;
    const patch = {};
    for (const [key, val] of Object.entries(additional)) {
      const uebersetzt = {};
      if (val?.name && nameMap[val.name]) {
        uebersetzt.name = nameMap[val.name];
      }
      if (val?.override && traitMap[val.override]) {
        uebersetzt.override = traitMap[val.override];
      }
      if (Object.keys(uebersetzt).length) patch[key] = uebersetzt;
    }
  ...
  // Eintrags-Übersetzung hat Vorrang; wo dieser Converter nichts ändert, gibt
  // er `undefined` zurück statt des Originals (siehe "actionButtons").
  "weaponNotes": (notes, translation, _quelle, _kompendium, alle) => {
    if (typeof translation === 'string' && translation) return translation;
    // Eintrag mit „Notizen"-Übersetzung hat Vorrang – siehe "actionTrait".
    if (typeof alle?.Notizen === 'string' && alle.Notizen) return undefined;
    ...
    // Exakter Treffer; `in` greift auch bei leerem Zielwert.
    ...
    return ersetzt === notes ? undefined : ersetzt;
  },
  ...
  "choiceSetsTranslation": (original) => {
    ...
    const effectMap = {
      ...
      // Fertigkeitsnamen wortgleich mit der choiceMap oben halten.
      "Ancestry Skill Bonus (Academics)": "Fertigkeitsbonus Geisteswissenschaften (Abstammung)",
      "Ancestry Skill Bonus (Athletics)": "Fertigkeitsbonus Athletik (Abstammung)",
      "Ancestry Skill Bonus (Battle)": "Fertigkeitsbonus Kriegskunst (Abstammung)",
      "Ancestry Skill Bonus (Boating)": "Fertigkeitsbonus Seefahrt (Abstammung)",
      "Ancestry Skill Bonus (Common Knowledge)": "Fertigkeitsbonus Allgemeinwissen (Abstammung)",
      "Ancestry Skill Bonus (Driving)": "Fertigkeitsbonus Fahren (Abstammung)",
      "Ancestry Skill Bonus (Electronics)": "Fertigkeitsbonus Elektronik (Abstammung)",
      "Ancestry Skill Bonus (Faith)": "Fertigkeitsbonus Glaube (Abstammung)",
      "Ancestry Skill Bonus (Fighting)": "Fertigkeitsbonus Kämpfen (Abstammung)",
      "Ancestry Skill Bonus (Focus)": "Fertigkeitsbonus Fokus (Abstammung)",
      "Ancestry Skill Bonus (Gambling)": "Fertigkeitsbonus Glücksspiel (Abstammung)",
      "Ancestry Skill Bonus (Hacking)": "Fertigkeitsbonus Hacken (Abstammung)",
      "Ancestry Skill Bonus (Healing)": "Fertigkeitsbonus Heilen (Abstammung)",
      "Ancestry Skill Bonus (Intimidation)": "Fertigkeitsbonus Einschüchtern (Abstammung)",
      "Ancestry Skill Bonus (Language)": "Fertigkeitsbonus Sprache (Abstammung)",
      "Ancestry Skill Bonus (Notice)": "Fertigkeitsbonus Wahrnehmung (Abstammung)",
      "Ancestry Skill Bonus (Occult)": "Fertigkeitsbonus Okkultismus (Abstammung)",
      "Ancestry Skill Bonus (Performance)": "Fertigkeitsbonus Darbietung (Abstammung)",
      "Ancestry Skill Bonus (Persuasion)": "Fertigkeitsbonus Überreden (Abstammung)",
      "Ancestry Skill Bonus (Piloting)": "Fertigkeitsbonus Pilot (Abstammung)",
      "Ancestry Skill Bonus (Psionics)": "Fertigkeitsbonus Psionik (Abstammung)",
      "Ancestry Skill Bonus (Repair)": "Fertigkeitsbonus Reparieren (Abstammung)",
      "Ancestry Skill Bonus (Research)": "Fertigkeitsbonus Recherche (Abstammung)",
      "Ancestry Skill Bonus (Riding)": "Fertigkeitsbonus Reiten (Abstammung)",
      "Ancestry Skill Bonus (Science)": "Fertigkeitsbonus Naturwissenschaften (Abstammung)",
      "Ancestry Skill Bonus (Shooting)": "Fertigkeitsbonus Schießen (Abstammung)",
      "Ancestry Skill Bonus (Spellcasting)": "Fertigkeitsbonus Zaubern (Abstammung)",
      "Ancestry Skill Bonus (Stealth)": "Fertigkeitsbonus Heimlichkeit (Abstammung)",
      "Ancestry Skill Bonus (Survival)": "Fertigkeitsbonus Überleben (Abstammung)",
      "Ancestry Skill Bonus (Taunt)": "Fertigkeitsbonus Provozieren (Abstammung)",
      "Ancestry Skill Bonus (Thievery)": "Fertigkeitsbonus Diebeskunst (Abstammung)",
      "Ancestry Skill Bonus (Weird Science)": "Fertigkeitsbonus Verrückte Wissenschaft (Abstammung)",
    };
    // Namen der verliehenen Sachen in den Auswahl-Paketen
    // (`mutation.system.grants[].name`), wortgleich mit den übersetzten
    // Item-Namen der Packs.
    const grantMap = {
      "Academics": "Geisteswissenschaften",
      "Adaptable": "Anpassungsfähig",
      "Battle": "Kriegskunst",
      ...
      "Intimidation": "Einschüchtern",
      "Language": "Sprache",
      "Natural Claws": "Klauen",
      "Natural Horns": "Hörner",
      "Occult": "Okkultismus",
      "Performance": "Darbietung",
      "Piloting": "Pilot",
      "Psionics": "Psionik",
    ...
    for (const set of result) {
      ...
      for (const choice of (set?.choices || [])) {
        ...
        for (const grant of (choice?.mutation?.system?.grants || [])) {
          if (typeof grant?.name === 'string' && grantMap[grant.name] != null) {
            grant.name = grantMap[grant.name];
          }
        }
    ...
    // Nichts übersetzt → `undefined` statt einer Vollkopie, sonst überschreibt
    // diese Zuordnung ein anderes Modul, das denselben Array-Pfad belegt.
    return JSON.stringify(result) === JSON.stringify(original) ? undefined : result;
  }
};

// Core-Skills-Kompendium auf das Premium-Modul umstellen, damit neue Charaktere
// die übersetzten Fertigkeiten erhalten.
Hooks.once('ready', () => {
...
// Die beim Welt-Setup erzeugten Kartenstapel stecken in keinem Kompendium und
// tragen hart codierte Namen - Babele erreicht sie nicht. Umbenennung deshalb
// nach dem System-Setup ueber die Settings-IDs, beidseitig DE/EN. Nur GM, und
// nur wenn der Stapel exakt den anderen bekannten Namen traegt: ein selbst
// vergebener Name bleibt unberuehrt.
...
// Fehlt das Originalmodul, dauerhaft warnen.
Hooks.once('ready', () => {
...
Hooks.once('babele.init', (babele) => {
  ...
  // ActiveEffect.changes: Standard-"structured"-Converter durch ein einfaches
  // Pfad-Mapping ersetzen. Der structured-Converter benennt sein Objekt nach den
  // change-keys; kollidieren deren Präfixe (etwa "system.pace" und
  // "system.pace.running.die"), scheitert mergeObject und Babele bricht die
  // Übersetzung des ganzen Dokuments ab. changes sind reine Mechanik.
  ...
  // Babeles Standard-Zuordnung zeigt description auf "system.description.value",
  // SWADE speichert sie aber als String unter "system.description"; "notes" fehlt
  // im Standard ganz. Nur für Waffen ("Item.weapon").
  babele.registerMapping({
    'Item.weapon': {
  ...
  // Weitere Item-Typen mit description als String unter system.description
  // (nicht .value); action/edge/power/gear/shield haben Zusatz-Aktionen.
  babele.registerMapping({
    ...
    'Item.power': {
      description: 'system.description',
      actions: { path: 'system.actions.additional', converter: 'actionButtons' },
      // Feldname wie in swade-powers.json, damit vorhandene Eintrags-
      // Übersetzungen weiter greifen.
      'Ausprägung': { path: 'system.trapping', converter: 'powerTrapping' },
    },
  });

  // Verbrauchsgegenstände: Beschreibung als String unter system.description,
  // dazu die gespeicherten Ladungsnamen über den chargeNames-Converter.
  babele.registerMapping({
    'Item.consumable': {
      description: 'system.description',
...
// ActiveEffect-Übersetzungen; Babele erreicht diese Namen nicht.
...
// Längste zuerst, damit "Very Resilient" vor "Resilient" ersetzt wird.
const sortedEffectKeys = Object.keys(effectTranslations)
  .sort((a, b) => b.length - a.length);

// Im Fließtext nur an Wortgrenzen ersetzen, sonst wird "Tough" mitten in
// "Toughness" getroffen.
const escapeRegExp = (s) => s.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
const effectNamePatterns = sortedEffectKeys.map((en) => ({
  de: effectTranslations[en],
  regex: new RegExp(`(?<![\\p{L}\\p{N}])${escapeRegExp(en)}(?![\\p{L}\\p{N}])`, 'gu'),
}));

// Standard: Ein Textknoten wird nur ersetzt, wenn sein Inhalt EXAKT ein
// Tabellenname ist – zusammengesetzte Namen fremder Module blieben sonst halb
// übersetzt. imFliesstext=true (Chat): Ersatz an Wortgrenzen mitten im Satz.
function translateEffectNames(htmlEl, { imFliesstext = false } = {}) {
  if (!htmlEl) return;
  const walker = document.createTreeWalker(htmlEl, NodeFilter.SHOW_TEXT);
  while (walker.nextNode()) {
    const node = walker.currentNode;
    if (imFliesstext) {
      for (const p of effectNamePatterns) {
        const neu = node.textContent.replace(p.regex, p.de);
        if (neu !== node.textContent) node.textContent = neu;
      }
    } else {
      const roh = node.textContent;
      const kern = roh.trim();
      const de = kern ? effectTranslations[kern] : undefined;
      if (de) node.textContent = roh.replace(kern, de);
    }
  }
}

// @UUID-Links anreichern, sonst stehen sie als Rohtext da. TextEditor liegt seit
// v13 unter foundry.applications.ux.
...
// Nur SWADE-eigene Inhalte anfassen, sonst würden Teiltreffer wie "Quick" auch
// in fremden Fenstern ersetzt. Body und html sind ausgenommen, weil der <body>
// in einer SWADE-Welt selbst die Klasse "system-swade" trägt – closest() würde
// sonst bei jedem Knoten dort anschlagen und der Schutz liefe ins Leere.
function applyEffectNamesScoped(root, optionen = {}) {
  if (!root) return;
  const swadeSel = '[class*="swade"]:not(body):not(html), [data-effect-id]';
  if (root.closest?.(swadeSel)) {
    translateEffectNames(root, optionen);
  } else {
    for (const sub of root.querySelectorAll?.(swadeSel) ?? []) {
      translateEffectNames(sub, optionen);
    }
  }
}
...
// Der MutationObserver weiter unten startet erst bei 'ready', das Chat-Fenster
// entsteht aber davor – die beim Weltstart schon vorhandenen Nachrichten
// erreicht nur dieser Hook.
Hooks.on('renderChatMessageHTML', (message, html) => {
  if (!argaActive()) return;
  if (!sortedEffectKeys.length) return;
  applyEffectNamesScoped(html, { imFliesstext: true });
  translateEffectDescriptions(html);
});
...
Hooks.on('renderDocumentSheetV2', (app, html) => {
  ...
  // 2) Label "Fertigkeitsname" → "Alternative Fertigkeit" (die de.json des
  //    SWADE-Systems übersetzt "Alternative Skill" falsch)
...
// Diese Effekte zeigen den abstammungsspezifischen Item-Text statt des
// generischen (geteilte Handicap-IDs, Panzerung-Abstammung).
  ...
  const observer = new MutationObserver((mutations) => {
    for (const mutation of mutations) {
      for (const node of mutation.addedNodes) {
        ...
        // Nur innerhalb SWADE-eigener Inhalte ersetzen.
        applyEffectNamesScoped(node);
      }
    }
  });
...
// Hat ein Charakter ein Talent wie Frenzy, legt das SWADE-System dessen Aktion
// auf JEDE Waffe und beschriftet den Knopf fest als
// "<engl. Aktionsname> (<Quell-Item-Name>)". Ersetzt wird nur der sichtbare
// Text; data-action und die Aktionsdaten bleiben unangetastet, damit Wurf und
// Makro weiterlaufen. Erkennung ueber den Bindestrich im data-action:
// eingefuegte Schluessel heissen "<swid>-<key>", normale nie.
...
// swade-core-rules nutzt für seine Makro-Dialoge kein i18n; die Übersetzung
// läuft deshalb über DOM-Hooks, preCreate-Hooks und einen MutationObserver.
...
const macroDialogTranslations = new Map([
  ...
  // Die Großschreibung im Dialog macht nur CSS – im DOM steht "Search"/"Modules".
  // Die Schlüssel in Großbuchstaben weiter oben greifen deshalb nie.
  ["Search",                         "Suche"],
  ["Modules",                        "Module"],
  ...
  // Satz, den <strong>-Zahlen in Fragmente zerlegen; die Leerzeichen in den
  // Werten sind nötig, damit er zusammengesetzt richtig lautet.
...
// Kartenwerte des SWADE-Aktionsdecks, soweit sie nicht als Zahl stehen bleiben.
const cardValueNamesDE = { 11: 'Bube', 12: 'Dame', 13: 'König', 14: 'Ass' };
...
const dynamicDialogPatterns = [
  ...
  { regex: /^Card (\d+)$/,  replace: (m) => `Karte ${m[1]}` },
  // Kartenname: swade-core-rules setzt ihn als "<Wert> of <Farbe>" zusammen –
  // die Farbe kommt aus der Sprachdatei, das "of" steht englisch im Programmtext.
  // Deutsch: Farbe zuerst, Bildkarten ausgeschrieben. Der Name steht an zwei
  // Stellen desselben Fensters, deshalb Ersatz innerhalb des umgebenden Textes.
  { regex: /^(.*?)(\d{1,2}) of (Pik|Herz|Karo|Kreuz)(.*)$/,
    replace: (m) => `${m[1]}${m[3]} ${cardValueNamesDE[Number(m[2])] ?? m[2]}${m[4]}` },
];
...
for (const hook of ['renderDialogV2', 'renderDialog']) {
  Hooks.on(hook, (app, html) => {
    ...
    // Der deutsche Text ist länger; die Dialoge werden dadurch höher und der
    // Ausführen-Knopf rutscht aus dem Bild. Breiter ziehen und die Höhe neu
    // berechnen lassen.
    try {
...
// Makro-Dialoge aufs Sichtfenster deckeln: nur .dialog-content scrollt, die
// Knopfleiste .form-footer bleibt unten sichtbar. DialogV2-Aufbau:
// .window-content > form.dialog-form > (.dialog-content + footer.form-footer)
Hooks.once('ready', () => {
  if (!argaActive()) return;
...
// Babele übersetzt Name und Beschreibung eines Items, nicht aber seine
// ActiveEffects. Dieser Hook übersetzt sie beim Anlegen auf einem Akteur mit.
...
const macroEffectNameMap = new Map([
  ...
  ["Bleeding Out",       "Verblutend"],
  ["Rending",            "Zerfleischt"],
  // Rückfall, falls der Converter den erzeugten Effekt nicht erreicht
  ["Armor 1 (Ancestry)", "Panzerung 1 (Abstammung)"],
  ["Armor 2 (Ancestry)", "Panzerung 2 (Abstammung)"],
  ["Armor 3 (Ancestry)", "Panzerung 3 (Abstammung)"],
  ["Ancestry Toughness", "Robustheit (Abstammung)"],
...
// Hier den generischen armorDesc NICHT setzen, wenn der Effekt bereits eine
// abstammungsspezifische Beschreibung trägt.
...
const macroChatPatterns = [
  // Nur sichtbarer Text; Knopf-Klasse und data-payload bleiben unverändert,
  // sonst funktioniert "Karte zuweisen" nicht mehr.
...
// Das SWADE-System mischt bei der Effektdauer englische und deutsche Begriffe.
Hooks.once('ready', () => {
  if (!argaActive()) return;
...
// RollTable-Titel werden in einer Versalien-Schrift ohne ß-Glyphe gesetzt.
// Nur die Anzeige wird auf "ss" geändert, der gespeicherte Name bleibt.
Hooks.on('renderApplicationV2', (app, element) => {
  if (!argaActive()) return;
...
// Das Suchfeld der SWADE-Inhaltsübersicht filtert gegen die englischen
// Originalnamen – "Regeln" findet nichts, "rules" schon. Die native Suche wird
// gekappt (Klon entfernt direkte Listener, stopPropagation die delegierten) und
// durch einen Filter über den sichtbaren deutschen Text ersetzt.
...
Hooks.on('renderCompendiumTOC', (app, html) => {
  ...
  // Nur die seitenbasierte Regel-Übersicht; andere Kompendien haben diese
  // Struktur nicht und behalten ihre native Suche.
  ...
  // Der Modus-Umschalter würde den Ersatz-Filter überschreiben.
...
// Dasselbe für Item- und Akteur-Kompendien, die SWADE ebenfalls als
// CompendiumTOC öffnet (Variante li.toc-entry statt li.page).
Hooks.on('renderCompendiumTOC', (app, html) => {
  if (!argaActive()) return;
  ...
  // Die seitenbasierte Regel-Übersicht behandelt der Block oben.
  if (root.querySelector('li.page')) return;
...
// „Regeln" immer an den Anfang, alphabetisch stuende das Pack unter „R" mitten
// in der Liste. Nur <li>-Umordnung im Sidebar-DOM; die Banner werden danach neu
// vergeben, damit das Motiv von oben nach unten aufgeht.
const ARGA_RULES_PACK = 'swade-core-rules.swade-rules';

function argaMoveRulesFirst(root) {
  for (const rules of root.querySelectorAll(`li[data-pack="${ARGA_RULES_PACK}"]`)) {
    const parent = rules.parentElement;
    if (!parent) continue;
    // Nur innerhalb der eigenen Gruppe, Packs anderer Module bleiben stehen.
    const sibs = Array.from(parent.children).filter(
      (li) => li.matches?.('li[data-pack^="swade-core-rules."], li[data-pack="argas-swade-translation-german.makros"]')
    );
    const first = sibs[0];
    if (first && first !== rules) parent.insertBefore(rules, first);
  }
}
...
Hooks.on('renderCompendiumDirectory', (app, html) => {
  ...
  if (argaModuleDisabled()) return;
  argaSortSwadeDirectory(root);       // erst alphabetisch nach deutschem Namen …
  argaMoveRulesFirst(root);           // … dann „Regeln" an den Anfang …
  argaResortSwadeBanners(root);       // … dann die Banner auf die neuen Positionen
});
    ...
    try {
      ...
      if (entry.uuid) {
        ...
        if (sheet instanceof foundry.applications.api.ApplicationV2) {
          // Position als Render-Option uebergeben: Fenster mit mehrstufigem
          // Render bestimmen ihre Lage beim Oeffnen selbst, nachtraegliches
          // Verschieben verpufft dort.
        ...
        if (!pack) continue;
        // Wie beim Journal: Position als Render-Option, sonst verpufft sie.
        const packOpts = {};
...
// Verhindert ein zweites Begruessungsfenster, solange eines offen ist.
let argaWelcomeOpen = false;

async function argaShowWelcomeDialog() {
  if (argaWelcomeOpen) return;
  if (argaModuleDisabled()) return;
  // Drei Voraussetzungen fuer die vollstaendige Uebersetzung.
  ...
  // "Nicht mehr anzeigen" greift nur, solange die Voraussetzungen erfuellt sind,
  // die dieser Nutzer selbst beeinflussen kann - beim Spielleiter alle drei, bei
  // Spielern nur die Anzeigesprache. Faellt spaeter eine weg, erscheint das
  // Fenster trotz gesetztem Haken erneut.
  const dismissApplies = isGM ? (coreActive && isGerman && isMetric) : isGerman;
  try {
    if (dismissApplies && game.settings.get(MODULE_ID, 'welcomeDismissed')) return;
  } catch (e) {
    return;
  }
  ...
  // Liefert die drei Zellen einer Zeile des Rasters (Punkt | Text | Haken).
  // ✓/✗ bewusst als Textzeichen U+2713/U+2717: sie haben keine Emoji-Variante
  // und nehmen deshalb die per CSS gesetzte Farbe an.
  ...
  // Ein deaktiviertes Modul laesst sich zuschalten, ein fehlendes nicht.
  const coreInstalled = !!game.modules.get('swade-core-rules');

  const coreHint = coreActive ? ''
    : !coreInstalled
      ? `<div style="color:${RED};">Das kostenpflichtige Originalmodul <strong>SWADE Core Rules</strong> ist nicht installiert.<br>Ohne das Original findet <strong>keine Übersetzung</strong> statt – bitte zuerst installieren.</div>`
      : isGM
        ? `<div style="color:${RED};">Das kostenpflichtige Originalmodul <strong>SWADE Core Rules</strong> ist nicht aktiv.<br>Ohne das Original findet <strong>keine Übersetzung</strong> statt (beim Zuschalten startet die Welt neu).</div>`
        : `<div style="color:${RED};">Das Originalmodul <strong>SWADE Core Rules</strong> ist nicht aktiv – ohne das Original findet <strong>keine Übersetzung</strong> statt. Zuschalten kann es nur der Spielleiter.</div>`;
  const langHint = isGerman ? ''
    : `<div style="color:${RED};">Ohne deutsche Anzeigesprache übersetzt das Modul nicht – bitte umstellen.</div>`;
  const metricHint = isMetric ? ''
    : isGM
      ? `<div style="color:${RED};">Die deutschen Regeltexte nennen <strong>Kilogramm als Gewichtseinheit</strong> – daher bitte auf metrisch umstellen. Bereits in der Welt vorhandene (Kompendiums-) Gegenstände werden automatisch umgerechnet. Wird die Gewichtseinheit später wieder auf imperial zurückgestellt, erhalten die Gegenstände ihr ursprüngliches Gewicht in Pfund zurück.</div>`
      : `<div style="color:${RED};">Die deutschen Regeltexte nennen <strong>Kilogramm als Gewichtseinheit</strong>. Umstellen kann die Gewichtseinheit nur der Spielleiter.</div>`;
  ...
  const dynamic = `
      ...
      <div style="display:grid;grid-template-columns:auto auto auto;align-items:center;row-gap:0.55rem;width:fit-content;align-self:center;">
        ...
        ${checkRow(isMetric, 'Metrische Gewichtseinheiten (kg)')}
      </div>
      ${coreHint}
      ${langHint}
      ${metricHint}`;

  // Nur der obere Bereich (arga-welcome-scroll) scrollt; Haken und Knopfleiste
  // stehen darunter und bleiben sichtbar. Die Originalmaße am Logo sind nötig,
  // weil das Fenster sonst vor dem Laden des Bildes gemessen wird und danach
  // über den Bildschirmrand wächst.
  const content = `
    <div style="display:flex;flex-direction:column;gap:0.7rem;">
      <div class="arga-welcome-scroll" style="display:flex;flex-direction:column;gap:0.7rem;">
        <div style="text-align:center;"><img src="${LOGO}" alt="" width="436" height="255" style="display:block;max-width:240px;height:auto;margin:0 auto;border:none;"></div>
  ...
  // Ein Knopf setzt alles um, was dieser Nutzer setzen darf: Anzeigesprache
  // jeder, Gewichtseinheit und Zuschalten des Originalmoduls nur der
  // Spielleiter. Ein nicht installiertes Originalmodul bleibt ein Hinweis.
  const fixLang = !isGerman;
  const fixMetric = isGM && !isMetric;
  const fixCore = isGM && !coreActive && coreInstalled;

  const buttons = [];
  if (fixLang || fixMetric || fixCore) {
    buttons.push({
      action: 'fulfill',
      label: 'Voraussetzungen erfüllen',
      callback: async () => {
        let worldChanged = false;
        if (fixCore) {
          // Wie die Modulverwaltung: vorhandene Konfiguration kopieren und nur
          // diesen einen Eintrag setzen.
          try {
            const cfg = foundry.utils.deepClone(game.settings.get('core', 'moduleConfiguration') ?? {});
            cfg['swade-core-rules'] = true;
            await game.settings.set('core', 'moduleConfiguration', cfg);
            worldChanged = true;
          } catch (e) {
            ui.notifications?.warn('SWADE Core Rules konnte nicht zugeschaltet werden – bitte in der Modulverwaltung aktivieren.');
          }
        }
        if (fixMetric) {
          try {
            await game.settings.set('swade', 'weightUnit', 'metric');
            // Vor dem Neuladen abwarten. Zweites Argument: die Welt stand
            // vorher auf imperial, Zahlen ohne Merker sind also Pfund-Werte.
            const wapi = game.modules.get(MODULE_ID)?.api?.weight;
            if (wapi?.convertAllItemWeights) await wapi.convertAllItemWeights(true, false);
            worldChanged = true;
          } catch (e) {
            ui.notifications?.warn('Die Gewichtseinheit konnte nicht umgestellt werden – das kann nur der Spielleiter.');
          }
        }
        if (fixLang) {
          try { await game.settings.set('core', 'language', 'de'); } catch (e) {}
        }
        // Welt-Einstellungen wirken erst nach einem Neuladen bei allen Beteiligten.
        if (worldChanged) {
          try { if (game.user?.can('SETTINGS_MODIFY')) game.socket?.emit('reload'); } catch (e) {}
        }
        location.reload();
      },
    });
  ...
  const onRenderWelcome = (app) => {
    ...
    // Hoehe, Scrollbalken und Platzierung erledigt swade-fixes.css: die Klasse
    // zentriert ueber die eigene Groesse, ganz ohne Messung.
    el.classList.add('arga-welcome-zentriert');

    // Beim Verschieben muss die Zentrierung weichen; damit das Fenster dabei
    // nicht springt, wird die aktuelle Lage vorher fest uebernommen.
    const kopf = el.querySelector('.window-header');
    if (kopf) {
      kopf.addEventListener('pointerdown', () => {
        if (!el.classList.contains('arga-welcome-zentriert')) return;
        const b = el.getBoundingClientRect();
        const links = Math.round(b.left);
        const oben = Math.round(b.top);
        el.classList.remove('arga-welcome-zentriert');
        el.style.left = `${links}px`;
        el.style.top = `${oben}px`;
        try { Object.assign(app.position, { left: links, top: oben }); } catch (e) {}
      }, { capture: true });
    }
  };
  Hooks.on('renderDialogV2', onRenderWelcome);

  argaWelcomeOpen = true;
  try {
    ...
    argaWelcomeOpen = false;
  }
}

Hooks.once('ready', async () => {
  // Beim Umschalten per Makro das Begrüßungsfenster einmalig überspringen.
  try {
  ...
  await argaShowWelcomeDialog();
});

// Wird die Gewichtseinheit im laufenden Spiel zurueckgestellt, ist eine
// Voraussetzung wieder offen. Nur beim Spielleiter, denn nur er kann sie
// zurueckstellen - Mitspieler saehen sonst ein Fenster ohne Handhabe.
Hooks.on('updateSetting', (setting) => {
  if (!game.user?.isGM) return;
  const key = setting?.key ?? `${setting?.namespace ?? ''}.${setting?.name ?? ''}`;
  if (key !== 'swade.weightUnit') return;
  let metric = false;
  try { metric = game.settings.get('swade', 'weightUnit') === 'metric'; } catch (e) {}
  if (metric) return;
  argaShowWelcomeDialog();
});
