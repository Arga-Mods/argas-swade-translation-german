...
async function argaToggleLanguage() {
  ...
  if (choice === "keep") {
    ...
    const collect = (app) => {
      try {
        ...
        if (uuid) {
          // Eingebettete Journal-Seiten nicht merken, sonst oeffnet das
          // Wiederherstellen jede Kapitelseite einzeln als Editor.
  ...
  // register.js ueberspringt das Begruessungsfenster nach diesem Neuladen.
